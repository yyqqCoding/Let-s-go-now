...
from app.nodes import build_itinerary, estimate_budget, final_output, generate_candidates, parse_intent, select_core_places, verify_plan
...
def build_trip_graph():
    ...
    当前仍由 build_itinerary 调用真实模型生成完整行程；V0.4 已在生成行程前完成核心地点选择。
    """
    ...
    builder.add_edge("select_core_places", "build_itinerary")
